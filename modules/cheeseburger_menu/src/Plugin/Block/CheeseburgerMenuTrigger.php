...
class CheeseburgerMenuTrigger extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityTypeManagerInterface $entity_type_manager, ConfigFactoryInterface $config_factory, BreakpointManagerInterface $break_point_manager = NULL) {
